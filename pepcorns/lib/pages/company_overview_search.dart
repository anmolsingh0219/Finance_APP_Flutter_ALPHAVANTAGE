                    ...
                    return ListTile(
                      ...
                      onTap: () async {
                        final alphaVantageService = AlphaVantageService(
                            'IZ23MS9GGCJXHBQJ'); // Replace with your API key
                        final companyOverview = await alphaVantageService
                            .fetchCompanyOverview(asset.symbol);
                        Navigator.push(
                          context,
                          MaterialPageRoute(
